...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='proyecto',
            name='Participantes',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, related_name='proyectos_participantes', to=settings.AUTH_USER_MODEL),
